...
# This model uses the efficient sub-pixel convolution layer described in `"Real-Time Single Image and Video Super-Resolution Using an Efficient
...
print("Model created with upscale factor ", upscale_factor)
...
# Input to the model
x = torch.randn(batch_size, 1, 640, 480, requires_grad=True)
...
img = Image.open("../a100_superresolution_1_tuned/cat.jpg")
...
final_img.save("./cat_upscaled.jpg")
